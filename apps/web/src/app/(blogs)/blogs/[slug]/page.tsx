...
import { calculateDate, calculateReadingTime, totalWords } from "@/lib/calculate";
      ...
      <div className={"container max-w-6xl mt-16 mx-auto"}>
        <div className="flex flex-col justify-between">
          <div className="text-xs space-x-1 mb-2 font-[800] text-gray-900 text-center">
            ...
            <span>{Math.round(Number(data.readingTime.toFixed(1)))} MIN READ |</span>
            <span className="text-blue-500 font-bold">CHETAN GUPTA </span>
          </div>
          <div className="text-gray-800 font-[800] sm:text-6xl text-4xl  mb-2 text-center break-all">{data.title}</div>

    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-14 sm:max-w-screen-xl items-center max-w-screen-sm">
        <div className="flex justify-start gap-8 sm:gap-12 md:gap-20 lg:gap-24">
          <Link className="items-center space-x-2 text-blue-600 font-bold" href="/">
            Home
          </Link>
          <Link className=" items-center space-x-2 text-blue-600 font-bold" href="/blogs">
            Blogs
          </Link>
        </div>
        <div className="flex flex-1 items-center justify-end">
          <nav className="flex items-center space-x-6">
            <Link target="_blank" rel="noreferrer" href="https://github.com/chetanguptaa">
